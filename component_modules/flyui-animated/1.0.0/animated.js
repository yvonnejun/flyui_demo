...
var FOUR_DIRECTIONS = ["left", "right", "up", "down"],
    IN_OUT = ["in", "out"],
    TRANSFER_START_STATE = { position: "absolute", marginLeft: 0, marginTop: 0, scale: 1 };
...
var Effect = Class.extend({
    ...
    ctor: function (element, direction) {
        var that = this;
    ...
    stop: function () {
        ...
        $(this.element).flyStop(true, true);
        return this;
    },
...
$.extend(fx, {
    ...
    promise: function (element, options) {
        var effects = [],
            ...
            parsedEffects = parseEffects(options.effects),
            effect;
...
fx.animatedPromise = fx.promiseShim = fx.promise;
...
if (transitions) {
    extend(fx, {
        ...
        stopQueue: function (element, clearQueue, gotoEnd) {
            ...
            if (retainPosition) {
                cssValues = fly.getComputedStyles(element[0], taskKeys);
            }
...
function clipInHalf(container, direction) {
    var vertical = directions[direction].vertical,
